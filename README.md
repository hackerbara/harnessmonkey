...
| [`codex-work-drawer`](https://github.com/hackerbara/harnessmonkey/tree/main/packages/codex-work-drawer) | Passively shows recent OpenAI Codex assistant messages in the shared footer drawer, sourced from local Codex companion/session files. | — |
